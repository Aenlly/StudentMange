<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adm_Stu_edit.aspx.cs" MasterPageFile="~/MasterPageAdmin.master" Inherits="Adm_Stu_edit" %>
                    ...
                    <div class="form-horizontal col-sm-10" role="form">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-8">
                                ...
                                <asp:FileUpload ID="Fup_head" runat="server" ClientIDMode="Static" />
                                <asp:Label ID="Lb_head" runat="server" ForeColor="Red"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="Fup_head" runat="server" ErrorMessage="学籍照片必须上传！" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="Fup_head" runat="server" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.bmp|.BMP|.png|.png|.jpg|.JPG)$" ErrorMessage="文件类型必须是bmp、png或jpg!" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                            </div>
                        </div>
                            ...
                            <ContentTemplate>
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="Ddl_col_edit" runat="server" ErrorMessage="学院不能为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="Ddl_pro_edit" runat="server" ErrorMessage="专业不能为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="Ddl_cla_edit" runat="server" ErrorMessage="班级不能为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        &nbsp;
                            <a href="Adm_Stu.aspx" class="btn btn-default btn-lg">返回</a>
                        &nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Lbtn_edit_ok" runat="server" CssClass="btn btn-primary btn-lg" OnClick="Btn_edit_Click" Text="确认"></asp:Button>
                    </div>
                </div>
            </div>
        </div>
